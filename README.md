...
| Oct 2017 | <a href="https://mackeepersecurity.com/post/patient-home-monitoring-service-leaks-private-medical-data-online">Patient Home Monitoring Service Leaks Private Medical Data Online</a>| publically accessible Amazon S3 47.5 GB / 316,363 PDF Medical records in the form of weekly blood test results, containing patients names, addresses, phone numbers, and test results.The PDF documents were named after the patients and included the First / Last Names and datesDevelopment Server Backup Doctor’s names, case management notes, additional client information|
